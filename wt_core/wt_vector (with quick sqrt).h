...
{
    return 1.0 / wt_sqrt_inv_quick(v1.x * v1.x + v1.y * v1.y);
}

static inline wt_r32 wt_invlen(wt_vec v1)
{
    return wt_sqrt_inv_quick(v1.x * v1.x + v1.y * v1.y);
}
